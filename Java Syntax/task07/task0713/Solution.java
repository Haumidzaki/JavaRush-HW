...
public class Solution {
    ...
    BufferedReader reader = new BufferedReader(new InputStreamReader(System.in) );
        ...
        ArrayList<Integer> list1 = new ArrayList<Integer>() ; // для чисел % 3
        ArrayList<Integer> list2 = new ArrayList<Integer>() ; // для чисел % 2
        ArrayList<Integer> list3 = new ArrayList<Integer>() ; // все остальные числа

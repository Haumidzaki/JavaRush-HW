...
Требования:
•	Метод containsBones в классе BodyPart должен иметь тип возвращаемого значения 
Object.
•	Класс Finger должен быть потомком класса BodyPart.
•	Метод containsBones в классе Finger должен иметь тип возвращаемого значения 
Object.
•	Метод containsBones в классе BodyPart должен возвращать строку "Yes".
•	Метод containsBones в классе Finger должен возвращать строку "Yes", если 
метод containsBones в классе BodyPart возвращает "Yes" и флаг isArtificial равен false, если приведенное условие не выполняется - вернуть "No".
...
"Yes" для этой части тела, а если "No", то строку формата "name(имя части тела)
не содержит кости".
*/

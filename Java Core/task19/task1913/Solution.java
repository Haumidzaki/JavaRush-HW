...
3. Класс TestString должен содержать публичный void метод
printSomething().
4. Метод printSomething() класса TestString должен выводить
на экран строку "it's 1 a 23 text 4 f5-6or7 tes8ting".
5. Метод main(String[] args) класса Solution должен создавать
поток PrintStream (используй PrintStream c параметром конструктора
...
троку выведенную методом printSomething()
*/
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String res = text.replaceAll("[^0-9]","");//stringBuilder.toString();

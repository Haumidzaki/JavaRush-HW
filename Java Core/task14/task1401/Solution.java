...
/* 
Bingo!
Исправь строчку 'Object animal = new Pet();' в методе main так, 
чтобы программа вывела "Bingo!".

Требования:
•	Класс Cat должен наследоваться от класса Pet.
•	Класс Tiger должен наследоваться от класса Cat.
•	В переменной Object animal должен храниться объект который 
будет одновременно являться и Pet, и Cat, и Tiger.
